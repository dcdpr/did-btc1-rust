...
pub fn bip340_sign(message_hash: &[u8; 32], private_key_bytes: &[u8]) -> Result<[u8; 64], Error> {
...
pub fn multibase_decode(encoded: &str) -> Result<Vec<u8>, Error> {
